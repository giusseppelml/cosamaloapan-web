...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarArtículo" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="categoriaArticulo" type="hidden" class="form-control" value="alcalde">
	...
	<?php
		...
		$crearArticulo -> guardarArticuloController("alcalde");
	...
	<?php
		...
		$mostrarArticulo -> mostrarArticulosController("alcalde");
