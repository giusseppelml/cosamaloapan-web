...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarArtículo" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<textarea name="introArticulo" id="" cols="30" rows="5" placeholder="Introducción" class="form-control"  maxlength="170" required></textarea>
			...
			<input name="categoriaArticulo" type="hidden" placeholder="Categoria" class="form-control" value="educacion">
	...
	<?php
		...
		$crearArticulo -> guardarArticuloController("educacion");
	...
	<?php
		...
		$mostrarArticulo -> mostrarArticulosController("educacion");
