...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarArtículo" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="categoriaArticulo" type="hidden" placeholder="Categoria" class="form-control" value="salud">
	...
	<?php
		...
		$crearArticulo -> guardarArticuloController("salud");
	...
	<?php
		...
		$mostrarArticulo -> mostrarArticulosController("salud");
