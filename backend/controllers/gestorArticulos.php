...
class GestorArticulos{
	...
	public function mostrarArticulosController($categoria){

		$respuesta = GestorArticulosModel::mostrarArticulosModel("articulos", $categoria);		
