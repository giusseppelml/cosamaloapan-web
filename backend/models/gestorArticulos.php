...
class GestorArticulosModel{
	...
	public function guardarArticuloModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (titulo, introduccion, ruta, contenido, categoria, fecha) VALUES (:titulo, :introduccion, :ruta, :contenido, :categoria, :fecha)");
	...
	#MOSTRAR ARTÍCULOS
	#------------------------------------------------------
	public function mostrarArticulosModel($tabla, $categoria){

		$stmt = Conexion::conectar()->prepare("SELECT id, titulo, introduccion, ruta, contenido FROM $tabla WHERE categoria = '$categoria' ORDER BY orden ASC");
